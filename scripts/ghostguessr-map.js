  ...
  function init() {
        ...
        this.addEventListener("load", function () {
          try {
            ...
            if (matches && matches.length > 0) {
              ...
              // Überprüfe ob Settings vorhanden sind
              if (GG.settings && GG.settings.enabled) {
    ...
    GG.updateMarkerStyle = function () {
      ...
      try {
        ...
        console.error("Error updating marker style:", e);
      }
    };
    ...
    if (GG.settings && GG.settings.enabled && GG.coords.lat && GG.coords.lng) {
      setTimeout(() => GG.ensureMarkerVisible(), 1000);
    }
  }
